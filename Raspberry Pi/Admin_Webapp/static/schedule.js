        ...
        function addSchedule(event) {
            ...
            const repeat = form.repeat.value === 'true' ? 'true' : '';
            // if repeat is false, set days to empty string and endRepeat to empty string (in case they are not empty)
            if (repeat === '') {
                form.days.value = '';
                form.endRepeat.value = '';
            }
